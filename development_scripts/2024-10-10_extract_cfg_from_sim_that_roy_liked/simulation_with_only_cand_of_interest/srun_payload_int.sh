...
###OPTIONS
Duration_Seconds=60 #Simulation Duration in seconds
Batch_Run_Label='this_should_work' #Label for the batch run folder
...
current_gen=$((gen_count-1)) #latest generation is the current generation
