...
def get_cell_numbers_from_fitness_target_script():
    ...
    from workspace.RBS_network_simulations.workspace.optimization_projects.CDKL5_DIV21._2_batchrun_optimization.batch_run_helper import import_module_from_path
...
if cfg.networkType == '07Oct24':
    ...
    from temp_user_args import USER_seconds
