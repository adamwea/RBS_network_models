...
npy_path = '/pscratch/sd/a/adammwea/workspace/RBS_network_simulations/workspace/optimization_projects/CDKL5_DIV21/_1_derive_features_from_experimental_data/network_metrics/network_metrics_well000.npy'
network_metrics = numpy.load(npy_path, allow_pickle=True).item()
...
output_dir = '/pscratch/sd/a/adammwea/workspace/RBS_network_simulations/workspace/optimization_projects/CDKL5_DIV21/_1_derive_features_from_experimental_data/derived_fitness_args'
from datetime import datetime
timestamp = datetime.now().strftime("%Y%m%d-%H%M%S")
output_path = output_dir + '/fitness_args_' + timestamp + '.py'
#conver all '-' to '_' in the timestamp
