...
if __name__ == '__main__':
    ##run in perlmutter login node - necessary for hdf5 plugin
    #shifter --image=docker:adammwea/axonkilo_docker:v7 python /pscratch/sd/a/adammwea/workspace/RBS_network_simulations/workspace/optimization_projects/CDKL5_DIV21/_1_derive_features_from_experimental_data/_2_plot_CDKL5_DIV21.py
    '''Args'''
