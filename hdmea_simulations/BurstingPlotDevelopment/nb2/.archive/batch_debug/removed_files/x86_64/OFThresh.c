...
#define nrn_init _nrn_init__OFTH
#define _nrn_initial _nrn_initial__OFTH
#define nrn_cur _nrn_cur__OFTH
#define _nrn_current _nrn_current__OFTH
#define nrn_jacob _nrn_jacob__OFTH
#define nrn_state _nrn_state__OFTH
#define _net_receive _net_receive__OFTH 
#define iassign iassign__OFTH 
#define states states__OFTH 
#define version version__OFTH 
...
#define dt _nt->_dt
#define gkbase _p[0]
#define gkbase_columnindex 0
#define taugka _p[1]
#define taugka_columnindex 1
#define spkht _p[2]
#define spkht_columnindex 2
#define tauk _p[3]
#define tauk_columnindex 3
#define ek _p[4]
#define ek_columnindex 4
#define vth _p[5]
#define vth_columnindex 5
#define refrac _p[6]
#define refrac_columnindex 6
#define verbose _p[7]
#define verbose_columnindex 7
#define apdur _p[8]
#define apdur_columnindex 8
#define gkinc _p[9]
#define gkinc_columnindex 9
#define tauvtha _p[10]
#define tauvtha_columnindex 10
#define vthinc _p[11]
#define vthinc_columnindex 11
#define gna _p[12]
#define gna_columnindex 12
#define ena _p[13]
...
#define gnamax _p[17]
#define gnamax_columnindex 17
#define gkmin _p[18]
#define gkmin_columnindex 18
#define inrefrac _p[19]
#define inrefrac_columnindex 19
#define gk _p[20]
#define gk_columnindex 20
#define vthadapt _p[21]
#define vthadapt_columnindex 21
#define gkadapt _p[22]
#define gkadapt_columnindex 22
#define iother _p[23]
#define iother_columnindex 23
#define Dgk _p[24]
#define Dgk_columnindex 24
#define Dvthadapt _p[25]
#define Dvthadapt_columnindex 25
#define Dgkadapt _p[26]
#define Dgkadapt_columnindex 26
#define v _p[27]
...
extern "C" {
 ...
 static double _hoc_fflag(void*);
 static double _hoc_iassign(void*);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 OFTH /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/OFThresh.mod\n");
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = gk_columnindex;  _dlist1[0] = Dgk_columnindex;
 _slist1[1] = gkadapt_columnindex;  _dlist1[1] = Dgkadapt_columnindex;
 _slist1[2] = vthadapt_columnindex;  _dlist1[2] = Dvthadapt_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/OFThresh.mod";
static const char* nmodl_file_text = 
