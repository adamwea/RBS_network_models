...
#define Irates Irates__nacurrent 
#define hrates hrates__nacurrent 
#define iassign iassign__nacurrent 
#define mrates mrates__nacurrent 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "Irates_nacurrent", _hoc_Irates,
 "hrates_nacurrent", _hoc_hrates,
 "iassign_nacurrent", _hoc_iassign,
 "mrates_nacurrent", _hoc_mrates,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 nacurrent /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/nacurrent.mod\n");
...
static int Irates(_threadargsprotocomma_ double);
static int hrates(_threadargsprotocomma_ double);
static int iassign(_threadargsproto_);
static int mrates(_threadargsprotocomma_ double);
...
static int  hrates ( _threadargsprotocomma_ double _lv ) {
   double _la , _lb ;
...
static void _hoc_hrates(void) {
  ...
  _nt = nrn_threads;
 _r = 1.;
 hrates ( _p, _ppvar, _thread, _nt, *getarg(1) );
 hoc_retpushx(_r);
}
 
static int  Irates ( _threadargsprotocomma_ double _lv ) {
   double _la , _lb ;
...
static void _hoc_Irates(void) {
  ...
  _nt = nrn_threads;
 _r = 1.;
 Irates ( _p, _ppvar, _thread, _nt, *getarg(1) );
 hoc_retpushx(_r);
}
 
static int  mrates ( _threadargsprotocomma_ double _lv ) {
   double _la , _lb ;
...
static void _hoc_mrates(void) {
  ...
  _nt = nrn_threads;
 _r = 1.;
 mrates ( _p, _ppvar, _thread, _nt, *getarg(1) );
 hoc_retpushx(_r);
}
 
static int  rates ( _threadargsprotocomma_ double _lv ) {
   mrates ( _threadargscomma_ _lv ) ;
   hrates ( _threadargscomma_ _lv ) ;
   Irates ( _threadargscomma_ _lv ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/nacurrent.mod";
static const char* nmodl_file_text = 
