...
ntasks=32 #need to find a nuumber of tasks that works well. Ideally some multiple of pop.
...
python3 batchRun_bestCase.py -rp ${container_run_path} -d ${Duration_Seconds} -l ${Batch_Run_Label}
