...
def handle_params_import():
	...
	try:
		...
		from simulate.batchRun_evolutionary_algorithm import rangify_params # use rangify_params from batchRun script to treat params as if it were imported from batchRun script
		params = rangify_params(params)
	return params

def get_cell_numbers_from_fitness_target_script():
    from simulate.batchRun_evolutionary_algorithm import import_module_from_path
