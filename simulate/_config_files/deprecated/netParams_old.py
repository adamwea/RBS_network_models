...
if cfg.networkType == '07Oct24':  # Network used for grant proposal in October 2024
	...
	def generate_exc_neuron_params(cfg, neuron_id):
		params = {}
	...
	def generate_inh_neuron_params(cfg, neuron_id):
		params = {}
		params['id'] = neuron_id  # Assign a unique ID
...
if cfg.networkType == '27Sep24':  # Network used for grant proposal in June 2024
	...
	except: from simulation_config_files.evolutionary_parameter_space import params; seconds = params['duration_seconds'][0]
	...
	#This fix is kinda hacky, but it works for now
	try: seconds = cfg.duration_seconds
	except: from simulation_config_files.evolutionary_parameter_space import params; seconds = params['duration_seconds']
