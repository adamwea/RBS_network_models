...
seed_paths = [
    {
        "path": "/pscratch/sd/a/adammwea/workspace/yThroughput/zRBS_network_simulation_outputs/CDKL5_DIV21/241126_Run2_improved_netparams/gen_1/"
        "gen_1_cand_58_data.json",
        "comment": "Bad fitness, too much constant activity - "
        "but both populations are firing and appear to "
        "oscillate.",
        "seed": False
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace"
        "/yThroughput/zRBS_network_simulation_outputs"
        "/CDKL5_DIV21/241126_Run2_improved_netparams/gen_1/"
        "gen_1_cand_26_data.json",
        "comment": "Not a lot of bursting. "
        "Decent fit, probably better than it should be. "
        "Both populations are firing and appear to oscillate.",
        "seed": True
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/yThroughput/"
        "zRBS_network_simulation_outputs/CDKL5_DIV21/"
        "241126_Run2_improved_netparams/gen_1/"
        "gen_1_cand_13_data.json",
        "comment": "Best activity so far. "
        "Both populations are firing and appear to oscillate."
        "Bursts vary in size and frequency. Amplitudes are "
    ...
    },
    {
        ...
        "gen_1/gen_1_cand_32_data.json",
        "comment": "Good activity. Both populations are"
        " firing and appear to oscillate. "
        "Bursts are fairly consistent. "
        "Amplitudes are similar to the last seed.",
        #"seed": True
    ...
    },
    {
        ...
        "/zRBS_network_simulation_outputs/CDKL5_DIV21/"
        "241126_Run2_improved_netparams/gen_1/"
        "gen_1_cand_64_data.json",
        "comment": "Good activity. Both populations are "
        "firing and appear to oscillate. Bursts are the "
        "most defined here.",
        "seed": True
    },
    {
        ...
        "seed": True   # switched to true after further review. E rates are higher than I rates. This is still a pretty bad simulation. Constant activity is too high. 
                        # no real bursting.
                        # actually ended up switching back to
                        # true after fixing convolution params
                        # in order to see bursting better.
                        
                        #this is firing way too oftern but 
                        # the inhibitory population is firing
                        # more than the excitatory population
    ...
    },
    {
        ...
        "zRBS_network_simulation_outputs/CDKL5_DIV21/"
        "241126_Run2_improved_netparams/gen_1/"
        "gen_1_cand_73_data.json",
        "comment": "Good oscillations. "
        "Too much constant activity. Not enough bursting.",
        "seed": False
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
    ...
    },
    {
        ...
        "/yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams/gen_1/"
        "gen_1_cand_66_data.json",
        "comment": "Almost identical to the last seed."
        "Good oscillations. "
        "Too much constant activity. Not enough bursting.",
        #"seed": False
        "seed": True # consider this on third pass...
    ...
    },
    {
        ...
        "/yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams"
        "/gen_1/gen_1_cand_6_data.json",
        "comment": "Really interesting activity. "
        "Neurons appear to fire in a way that is "
        "stochastic but also rhythmic. Amplitude "
        "is exactly where it should be, but the activity "
        "is still too constant. Activity konks out "
        "partway through the simulation.",
        #"seed": False
        "seed": True # no I want to include this for 
                    #its naturalistic activity. 
                    # #E/I ratio is good. 
                    # Only issue is the konking out.
                    # NOTE: Why does that happen?
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams/gen_1/"
        "gen_1_cand_19_data.json",
        "comment": "Super consistent bursting. "
        "Too much constant activity. Amplitude is too high.",
        "seed": False
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace"
        "/yThroughput/zRBS_network_simulation_outputs"
        "/CDKL5_DIV21/241126_Run2_improved_netparams"
        "/gen_2/gen_2_cand_39_data.json",
        "comment": "Probably the best activity so far."
        " E rates are higher than I rates. "
        "Activity looks erratic and more natural "
        "than others. Amplitude is acceptable. "
    ...
    },
    {
        ...
        "/yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams"
        "/gen_2/gen_2_cand_79_data.json",
        "comment": "Nice clear oscillations. "
        "Too much constant activity. "
        "Bursts are super non-distinct from "
        "background activity. Amplitude is too high. "
    ...
    },
    {
        ...
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams"
        "/gen_2/gen_2_cand_31_data.json",
        "comment": "Very active. "
        "Too much constant activity. "
        "Burst timing is good, but amplitude is too high. "
        "Bursting with respect to background might be okay. "
        ...
        "seed": True # consider this on third pass...
                    ...
                    # this one is tricky.
                    # E/I ratio is good - I neurons
                    # firing pretty constantly.
                    # E neurons firing in bursts...albeit
                    # too much constant activity.
                    # but the relative amplitude of the bursts
                    # is good.
                    # firing on raster looks diffuse in a more 
                    # natural way.
                    # I think I will seed this one.
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams/"
        "gen_2/gen_2_cand_41_data.json",
        ...
        #"seed": True
        "seed": False # switched to false after further 
                    # review. it's wild how much worse
                    # this one is looks after updating the
                    # convolution params.
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams/"
        "gen_2/gen_2_cand_73_data.json",
        "comment": "Same notes as above basically, "
        "but better bursting and general network "
        "activity shape.",
        "seed": True
        # actually this one is much better than the one above. 
        # amplitude is right where it should be.
        # theres some variance in burst amplitdue which is nice.
        # its just very regular, which is not great.
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams/"
        "gen_2/gen_2_cand_80_data.json",
        "comment": "Similar to the last two but not as good.",
        #"seed": False
        'seed': True # keep this one, 
                    #it's among the naturalistic ones.
                    
                    #after updating the convolution params
                    # its still pretty good.
                    # but much to regular to be called
                    # naturalistic.
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams/"
        "gen_2/gen_2_cand_60_data.json",
        "comment": "Probably the best activity so far. "
        "E rates are higher than I rates. "
        "Activity looks a little erratic and more natural "
        "than the others. Bursts are fairly distinct "
        "from background activity. "
        "Amplitude is acceptable, only a little high. "
        "Very comparable to experimental data in terms "
        "of general shape.",
        "seed": True
        
            # its actually not very comparable. and not
            # as 'erratic' as I once thought.
    ...
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams/gen_4/"
        "gen_4_cand_72_data.json",
        "comment": "Meh. Not great, but maybe good enough to "
        "seed.",
        #"seed": True
        ...
        "seed": True
            ...
            #eh, still not great but I is firing more than E
            # and its bursting so -shrug- 
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams"
        "/gen_3/gen_3_cand_6_data.json",
        "comment":"Oscillations are distinct but "
        "far too regular, not very natural. "
    ...
    },
    {
        ...
        # "seed": False
        "seed": True 
            # keep this one, it's also among the naturalistic 
            # ones. despite the konking out.
            
            # after updating the convolution params
            # super interesting activity - may have been 
            # an overstatement.
            
            # but still, this is pretty good and more natural
            # than most.
    },
    {
        "path": "/pscratch/sd/a/adammwea/workspace/"
        "yThroughput/zRBS_network_simulation_outputs/"
        "CDKL5_DIV21/241126_Run2_improved_netparams/"
        "gen_3/gen_3_cand_15_data.json",
        "comment": "Super meh. Not great, "
        "but maybe good enough to seed. "
