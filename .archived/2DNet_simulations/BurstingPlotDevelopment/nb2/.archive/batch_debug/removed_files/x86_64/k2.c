...
#define nrn_init _nrn_init__k2
#define _nrn_initial _nrn_initial__k2
#define nrn_cur _nrn_cur__k2
#define _nrn_current _nrn_current__k2
#define nrn_jacob _nrn_jacob__k2
#define nrn_state _nrn_state__k2
#define _net_receive _net_receive__k2 
#define _f_settables _f_settables__k2 
#define settables settables__k2 
#define states states__k2 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 k2 /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/k2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/k2.mod";
static const char* nmodl_file_text = 
