...
params['gnabar_I'] = [0.002, 0.4] # S/cm^2
params['gkbar_I'] = [0.001, 0.3] # S/cm^2
params['gl_I'] = [0.00001, 0.002] # S/cm^2
params['el_I'] = [-70] #mV
...
params['Irhythmic_stimWeight'] = [100] 
params['rythmic_stiminterval'] = [10]  # Interval between spikes (ms)
