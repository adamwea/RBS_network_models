...
# --------------------------------------------------------
	...
	# netParams.propVelocityInhib = cfg.propVelocityInhib # propagation velocity for inhibitory neurons (um/ms)
	# netParams.propVelocityExcite = cfg.propVelocityExcite # propagation velocity for excitatory neurons (um/ms)
