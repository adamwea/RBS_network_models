...
#define _f_settables _f_settables__ka 
#define settables settables__ka 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ka /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/ka.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/ka.mod";
static const char* nmodl_file_text = 
