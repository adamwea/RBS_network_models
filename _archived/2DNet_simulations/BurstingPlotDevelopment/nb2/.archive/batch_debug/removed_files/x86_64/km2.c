...
#define _f_settables _f_settables__km2 
#define settables settables__km2 
#define states states__km2 
...
#define alpha _p[4]
#define alpha_columnindex 4
#define beta _p[5]
#define beta_columnindex 5
#define Dm _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 km2 /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/km2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/km2.mod";
static const char* nmodl_file_text = 
