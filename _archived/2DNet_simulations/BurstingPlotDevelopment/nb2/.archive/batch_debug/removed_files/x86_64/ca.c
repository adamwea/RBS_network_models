...
#define nrn_init _nrn_init__ca_hnn
#define _nrn_initial _nrn_initial__ca_hnn
#define nrn_cur _nrn_cur__ca_hnn
#define _nrn_current _nrn_current__ca_hnn
#define nrn_jacob _nrn_jacob__ca_hnn
#define nrn_state _nrn_state__ca_hnn
#define _net_receive _net_receive__ca_hnn 
#define _f_trates _f_trates__ca_hnn 
#define rates rates__ca_hnn 
#define states states__ca_hnn 
#define trates trates__ca_hnn 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ca_hnn", _hoc_setdata,
 "efun_ca_hnn", _hoc_efun,
 "rates_ca_hnn", _hoc_rates,
 "trates_ca_hnn", _hoc_trates,
 0, 0
};
#define efun efun_ca_hnn
 extern double efun( double );
 /* declare global and static user variables */
#define cai cai_ca_hnn
 double cai = 0;
#define cao cao_ca_hnn
 double cao = 2.5;
#define q10 q10_ca_hnn
 double q10 = 2.3;
#define tshift tshift_ca_hnn
 double tshift = 30.7;
#define tadj tadj_ca_hnn
 double tadj = 0;
#define temp temp_ca_hnn
 double temp = 23;
#define usetable usetable_ca_hnn
 double usetable = 1;
#define vshift vshift_ca_hnn
 double vshift = 0;
#define vmax vmax_ca_hnn
 double vmax = 100;
#define vmin vmin_ca_hnn
 double vmin = -120;
 ...
 "vshift_ca_hnn", &vshift_ca_hnn,
 "cao_ca_hnn", &cao_ca_hnn,
 "cai_ca_hnn", &cai_ca_hnn,
 "temp_ca_hnn", &temp_ca_hnn,
 "q10_ca_hnn", &q10_ca_hnn,
 "tshift_ca_hnn", &tshift_ca_hnn,
 "vmin_ca_hnn", &vmin_ca_hnn,
 "vmax_ca_hnn", &vmax_ca_hnn,
 "tadj_ca_hnn", &tadj_ca_hnn,
 "usetable_ca_hnn", &usetable_ca_hnn,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ca_hnn /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/ca.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/ca.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
