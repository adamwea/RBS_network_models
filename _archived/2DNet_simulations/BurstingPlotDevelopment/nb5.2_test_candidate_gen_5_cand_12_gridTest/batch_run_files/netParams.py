...
# --------------------------------------------------------
	...
	#load seconds as needed I guess.
	with open('batch_config_options.json') as f:
		batch_config_options = json.load(f)
	if 'duration_seconds' in batch_config_options:
		cfg.duration_seconds = batch_config_options['duration_seconds']
	...
	# 		'yRange': [100,1900], 
	# 		'xRange': [100,3900]}
	assert load_success, "Failed to load network parameters from JSON file"	
