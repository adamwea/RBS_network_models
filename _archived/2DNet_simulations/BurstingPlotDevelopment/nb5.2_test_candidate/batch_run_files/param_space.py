...
def get_param_space(duration_seconds):
    ...
    try: import const_netParams as const_netparams
    except: import batch_run_files.const_netParams_excite as const_netparams
...
def get_param_space_excite_only(duration_seconds):
    #from const_netParams import get_const_netParams
    try: import const_netParams_excite as const_netparams
    except: import batch_run_files.const_netParams_excite as const_netparams
