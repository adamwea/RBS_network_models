...
def create_network(cfg, numExcitatory, numInhibitory, cell_positions=None):
    ...
    netParams.synMechParams['exc'] = {'mod': 'Exp2Syn', 
                                        'tau1': 'abs(normal({}, {}))'.format(cfg.tau1_exc, cfg.tau1_exc_stdev),
                                        'tau2': 'abs(normal({}, {}))'.format(cfg.tau2_exc, cfg.tau2_exc_stdev),
    ...
    netParams.synMechParams['inh'] = {'mod': 'Exp2Syn', 
                                        'tau1': 'abs(normal({}, {}))'.format(cfg.tau1_inh, cfg.tau1_inh_stdev),
                                        'tau2': 'abs(normal({}, {}))'.format(cfg.tau2_inh, cfg.tau2_inh_stdev),
