...
def get_batch_config(method, nodes, pop_size, max_generations, run_path, core_num, skip = True):
    ...
    batch_config = {
        ...
        'evolCfg': {
            ...
            'maxiter_wait': 200, # max number of times to check if sim is completed (for each generation)
