...
#define nrn_init _nrn_init__cat_hnn
#define _nrn_initial _nrn_initial__cat_hnn
#define nrn_cur _nrn_cur__cat_hnn
#define _nrn_current _nrn_current__cat_hnn
#define nrn_jacob _nrn_jacob__cat_hnn
#define nrn_state _nrn_state__cat_hnn
#define _net_receive _net_receive__cat_hnn 
#define _f_settables _f_settables__cat_hnn 
#define settables settables__cat_hnn 
#define states states__cat_hnn 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cat_hnn", _hoc_setdata,
 "settables_cat_hnn", _hoc_settables,
 0, 0
};
...
#define eca eca_cat_hnn
 double eca = 0;
#define usetable usetable_cat_hnn
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_cat_hnn", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "eca_cat_hnn", "mV",
 "gbar_cat_hnn", "mho/cm2",
 "i_cat_hnn", "mA/cm2",
 0,0
};
 ...
 "eca_cat_hnn", &eca_cat_hnn,
 "usetable_cat_hnn", &usetable_cat_hnn,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 cat_hnn /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/cat.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/cat.mod";
static const char* nmodl_file_text = 
