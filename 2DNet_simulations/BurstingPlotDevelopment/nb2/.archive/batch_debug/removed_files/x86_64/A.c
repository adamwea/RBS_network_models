...
#define VhlfMaxm_columnindex 2
#define VhlfMaxh _p[3]
#define VhlfMaxh_columnindex 3
#define slopem _p[4]
#define slopem_columnindex 4
#define slopeh _p[5]
#define slopeh_columnindex 5
#define taum _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 A /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/A.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/A.mod";
static const char* nmodl_file_text = 
  "NEURON { SUFFIX A }\n"
  ...
  "\n"
  ":::INCLUDE \"ofc.inc\"\n"
  ":::realpath /mnt/disk15tb/adam/git_workspace/netpyne/netpyne/tutorials/mod/ofc.inc\n"
