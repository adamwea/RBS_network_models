...
def handle_params_import(path=None):
    ...
    try:
        ...
        print('Could not import params from main script. Attempting to import from path...')
        #get params from script:
        #path = '/pscratch/sd/a/adammwea/workspace/RBS_network_simulations/workspace/optimization_projects/CDKL5_DIV21/parameter_spaces/_241202_adjusted_evol_params.py'
        #path = 'workspace/RBS_neuronal_network_models/optimization_projects/CDKL5_DIV21/_config/evol_parameter_spaces/241202_adjusted_evol_params.py'
        #path = '/pscratch/sd/a/adammwea/workspace/RBS_neuronal_network_models/optimization_projects/CDKL5_DIV21/scripts/fitting/evol_parameter_spaces/241202_adjusted_evol_params.py'
...
def get_cell_numbers_from_fitness_target_script():
    ...
    fitnessFuncArgs = import_module_from_path(USER_fitness_target_script)
...
# --------------------------------------------------------
#cfg.networkType = '07Oct24'  # Updating everything while working
cfg.networkType = '10Dec24'  # trying core neuron?
...
if cfg.networkType == '07Oct24':
    ...
    from batch_scripts.temp_user_args import USER_seconds
...
elif cfg.networkType == '10Dec24':
    # Import evolutionary parameters
    # evolParams_script_path = '/pscratch/sd/a/adammwea/workspace/RBS_neuronal_network_models/optimization_projects/CDKL5_DIV21/scripts/fitting/evol_parameter_spaces/241202_adjusted_evol_params.py'
    params = handle_params_import(evolParams_script_path)
    print('Evolutionary parameters imported successfully.')
