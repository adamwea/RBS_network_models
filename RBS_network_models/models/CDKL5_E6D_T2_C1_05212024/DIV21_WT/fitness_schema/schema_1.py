...
fit_schema = {
    ...
    'spiking_data':{
        ...
        'EI_fr_ratios': { # # aw 2025-05-20 15:11:08 current target=0.16742355633713643
            'min': 0.05, # value int/float submitted to fitness function
            'max': 1.0,  # value int/float submitted to fitness function
    ...
    'mega_bursting_data':{
        ...
        'burst_metrics': {
            'num_bursts': False,
            'burst_rate': {
                'min': False, # value int/float submitted to fitness function
                'max': False, # value int/float submitted to fitness function
                'normalize': False, # boolean - if True, after fitness scoring, score will be adjusted - normalized to the range of seed values 
                                    # NOTE: ignored if seeds are not provided. This should be used to pin down already optimized values
            },
            'burst_ids': False,
