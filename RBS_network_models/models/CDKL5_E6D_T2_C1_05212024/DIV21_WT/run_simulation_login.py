...
RBS_network_models.models.CDKL5_E6D_T2_C1_05212024.DIV21_WT.src.conv_params import conv_params, mega_params
from datetime import datetime

# paths ===================================================================================================
file_name = 'test_run' # define the filename for the simulation
date = datetime.now().strftime("%y%m%d")
npy_path = ('/global/homes/a/adammwea/pscratch/zoutputs/CDKL5-E6D_T2_C1_05212024/CDKL5-E6D_T2_C1_05212024/240611/M08029/Network/000091/network_analysis/well005/metrics.npy') # define the path to the metrics.npy file
saveFolder = (f'/global/homes/a/adammwea/pscratch/zoutputs/CDKL5-E6D_T2_C1_05212024_simulations/DIV21_WT/single_runs/{date}_{file_name}') # define the path to the save folder for the simulation
