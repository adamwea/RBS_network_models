...
# Notes ===================================================================================================
reference_data_path = (
    '/pscratch/sd/a/adammwea/workspace/RBS_network_models/data/Organoid_RTT_R270X/DIV112_WT/'
    'network_metrics/Organoid_RTT_R270X_pA_pD_B1_d91/'
    '250107/M07297/Network/000028/well005/network_metrics.npy'
    )
