...
def batchEvol_v2(**kwargs):
    ...
    def initialize_batch(**kwargs):
        ...
        b = Batch(
            cfgFile=str(Path(
                '~/workspace/RBS_network_models/RBS_network_models/Organoid_RTT_R270X/DIV112_WT/src/cfg.py').expanduser().resolve()),
            netParamsFile=str(Path(
                '~/workspace/RBS_network_models/RBS_network_models/Organoid_RTT_R270X/DIV112_WT/src/netParams.py').expanduser().resolve()),
            params=params,
            ## other options
            #cfg=None,
            #netParams=None,
